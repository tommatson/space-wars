...
OBJS = $(GAME_SRC_OBJS) $(GAME_SCENES_OBJS) $(RENDERER_OBJS) $(SYSTEMS_OBJS) $(NETWORK_OBJS) $(SOCKETS_OBJS) $(SCENE_OBJS) $(CORE_OBJS) $(IMGUI_OBJS)
...
dirs:
	mkdir -p $(BUILD_DIR) $(RENDERER_BUILD_DIR) $(SYSTEMS_BUILD_DIR) $(NETWORK_BUILD_DIR) $(SOCKETS_BUILD_DIR) $(SCENE_BUILD_DIR) $(CORE_BUILD_DIR) $(IMGUI_BUILD_DIR) $(GAME_SRC_BUILD_DIR) $(GAME_SCENES_BUILD_DIR)
